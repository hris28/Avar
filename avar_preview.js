...
const data = {
  players: [
    { name: "Mithe Demacia Khol", race: "Half-Elf", cls: "Bard", keyword: "BLOOD", age: 19, appearance: "5'6\", covered left eye", traits: "", connections: "" },
  ...
  npcs: [
    ...
    { name: "Alren Davarre", role: "Head of House Davarre", affil: "House Davarre / 1st Circle", status: "Active", notes: "Archivists; Gloamspire Tower; lost daughter Cynthia and brother Alden" },
    ...
    { name: "Lux", role: "High Elf Mage", affil: "Unknown party cohort", status: "Unknown", notes: "Joined a party cohort that disappeared; appeared in the time-vision as the 'high elf woman mage'" },
  ...
  theories: [
    ...
    { label: "Lux = The High Elf Mage in the Time Vision", detail: "She 'joined a party cohort that disappeared.' The time-vision showed a party of 5 including a high elf woman mage — strongly implied to be Lux." },
